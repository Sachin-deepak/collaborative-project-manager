...
// node_modules/nuqs/dist/chunk-3RCMAOX7.js
...
// node_modules/nuqs/dist/chunk-AOGHIZZC.js
...
function useQueryStates(keyMap, {
  ...
  if (Object.keys(queryRef.current).length !== Object.keys(keyMap).length) {
    queryRef.current = Object.fromEntries((initialSearchParams == null ? void 0 : initialSearchParams.entries()) ?? []);
  }
  ...
  (0, import_react.useEffect)(() => {
    ...
    Object.values(resolvedUrlKeys).map((key) => initialSearchParams == null ? void 0 : initialSearchParams.get(key)).join("&")
  ]);
  (0, import_react.useInsertionEffect)(() => {
